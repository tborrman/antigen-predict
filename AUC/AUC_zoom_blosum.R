...
plot_ROC <- function(scores, labels, TCR, path, x) {
  ...
  png(paste(path, "/", TCR, "/AUC/ROC_AUC_", TCR,"_", x, "_reads_cutoff_zoom_0.00005_blosum.png", sep=""), 
      height=1800, width=1800, res=300)
    plot(perf, col=as.list(mycolors), main=TCR, lwd=2, xlim=c(0, 0.00005), ylim=c(0,0.04))
