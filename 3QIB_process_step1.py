...
def main():
	parser = argparse.ArgumentParser(description= 'Deconvolute 3QIB seq data into rounds of selection from specific library')
	...
	OUT = open('3QIB_process_step1.fastq', 'w+')
