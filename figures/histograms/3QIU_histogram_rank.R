...
hist(score_table$standard, breaks=seq(-1000, 7000, by= 10), col='lightskyblue1', lty="blank", freq = FALSE, ylab = 'Density', xlab= "Rosetta 3.5 standard score",cex.main=1.8, cex.lab=1.5, 
...
par(mar=c(5,5,4,2) + 0.1)
hist(score_table$bind, breaks=seq(-200, 2000, by= 3), col='lightskyblue1', lty="blank",freq = FALSE, ylab = 'Density', xlab= "Rosetta 3.5 bind score",cex.main=1.8, cex.lab=1.5, 
...
par(mar=c(5,5,4,2) + 0.1)
hist(score_table$bind_pep_alone, breaks=seq(-200, 5000, by= 5), col='lightskyblue1', lty="blank", freq = FALSE, ylab = 'Density', xlab= "Rosetta 3.5 bind peptide alone score",cex.main=1.8, cex.lab=1.5, 
     main = paste("Round ", args$r, sep=""), xlim=c(-100, 2500), ylim=c(0,0.035))
...
par(mar=c(5,5,4,2) + 0.1)
hist(score_table$atlas, breaks=seq(-100, 200, by= 0.5), col='lightskyblue1', lty="blank", freq = FALSE, ylab = 'Density', xlab= "Rosetta 3.5 ATLAS score",cex.main=1.8, cex.lab=1.5, 
