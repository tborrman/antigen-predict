...
# Top 5 most abundant peptides for 3QIU
top5_peptides <- c("AAQVAFLKAATKA", "ADLVAFFKEASKR", "ADKIAFFKSVTKK", "ANLLGYHKVPTKK", "ADPVAFFRSPFKT")
...
hist(score_table$standard, breaks=2000, col='lightskyblue1',  lty="blank", ylab = 'Frequency', xlab= "Rosetta 3.5 standard score",cex.main=1.8, cex.lab=1.5, 
     main = paste("Round ", args$r, sep=""), xlim=c(-100,200), ylim=c(0,400))
...
par(mar=c(5,5,4,2) + 0.1)
hist(score_table$bind, breaks=3500, col='lightskyblue1',  lty="blank", ylab = 'Frequency', xlab= "Rosetta 3.5 bind score",cex.main=1.8, cex.lab=1.5, 
     main = paste("Round ", args$r, sep=""), xlim=c(-4, 13), ylim=c(0,800))
...
par(mar=c(5,5,4,2) + 0.1)
hist(score_table$bind_pep_alone, breaks=2000, col='lightskyblue1',  lty="blank", ylab = 'Frequency', xlab= "Rosetta 3.5 bind peptide alone score",cex.main=1.8, cex.lab=1.5, 
     main = paste("Round ", args$r, sep=""), xlim=c(-50, 160), ylim=c(0,1000))
...
par(mar=c(5,5,4,2) + 0.1)
hist(score_table$atlas, breaks=300, col='lightskyblue1',  lty="blank", ylab = 'Frequency', xlab= "Rosetta 3.5 ATLAS score",cex.main=1.8, cex.lab=1.5, 
     main = paste("Round ", args$r, sep=""), xlim=c(-40,-15), ylim=c(0,2000))
