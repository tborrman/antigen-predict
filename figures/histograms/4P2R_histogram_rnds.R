...
png(paste(wkdir, "/4P2R_histogram_rnds.png", sep=""), width=4000, height=900, res=300)
...
hist(dG_bind_0, breaks=seq(-1000,7000, by=50), col='forestgreen', lty="blank", xlab=expression(paste(Delta, "G", ""["BIND"], sep= "")),
		main="Preselection", xlim=c(-200,3500), cex.lab=2, cex.main=2)
box(bty="l")
par(xpd=FALSE)
hist(score_table_1$bind_pep_alone, breaks=seq(-1000,7000, by=50), col='forestgreen', lty="blank", ylab="", xlab=expression(paste(Delta, "G", ""["BIND"], sep= "")),
		main="Round 1", xlim=c(-200,3500), cex.lab=2, cex.main=2)
box(bty="l")
hist(score_table_2$bind_pep_alone, breaks=seq(-1000,7000, by=50), col='forestgreen', lty="blank", ylab="", xlab=expression(paste(Delta, "G", ""["BIND"], sep= "")),
		main="Round 2", xlim=c(-200,3500), cex.lab=2, cex.main=2)
box(bty="l")
hist(score_table_3$bind_pep_alone, breaks=seq(-1000,7000, by=50), col='forestgreen', lty="blank", ylab="", xlab=expression(paste(Delta, "G", ""["BIND"], sep= "")),
		main="Round 3", xlim=c(-200,3500), cex.lab=2, cex.main=2)
box(bty="l")
hist(score_table_4$bind_pep_alone, breaks=seq(-1000,7000, by=50), col='forestgreen', lty="blank", ylab="", xlab=expression(paste(Delta, "G", ""["BIND"], sep= "")),
