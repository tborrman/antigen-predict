...
par(mfrow=c(4,5), oma=c(6,8,5,2) + 0.1, mar=c(1,1,1,1) + 0.5)
...
hist(score_table_0$bind_pep_alone, breaks=seq(-200,5000, by=50), col='red', lty="blank", xlab="",
	 	main="",xlim=c(-200,3500), cex.lab=2, cex.main=2, cex.axis=1.5)
par(xpd=NA)
...
hist(score_table_0$bind_pep_alone, breaks=seq(-500, 4000, by=30), col='mediumorchid4', lty="blank", xlab="",
		main="", xlim=c(-100,2200), cex.lab=2, cex.main=2, cex.axis=1.5)
box(bty="l")
