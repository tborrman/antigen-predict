...
hist(score_table$standard, breaks=500, col='aquamarine', lty="blank", ylab = 'Frequency', xlab= "Rosetta 3.5 standard score",cex.main=1.8, cex.lab=1.5, 
     main = paste("Round ", args$r, sep=""), xlim=c(7475,7650), ylim = c(0,400))
...
par(mar=c(5,5,4,2) + 0.1)
hist(score_table$bind, breaks=250, col='aquamarine',  lty="blank", ylab = 'Frequency', xlab= "Rosetta 3.5 bind score",cex.main=1.8, cex.lab=1.5, 
     main = paste("Round ", args$r, sep=""), xlim=c(-5, 20), ylim=c(0,400))
...
par(mar=c(5,5,4,2) + 0.1)
hist(score_table$bind_pep_alone, breaks=800, col='aquamarine',  lty="blank", ylab = 'Frequency', xlab= "Rosetta 3.5 bind peptide alone score",cex.main=1.8, cex.lab=1.5, 
     main = paste("Round ", args$r, sep=""), xlim=c(-50,100), ylim=c(0,400))
...
par(mar=c(5,5,4,2) + 0.1)
hist(score_table$atlas, breaks=50, col='aquamarine',  lty="blank", ylab = 'Frequency', xlab= "Rosetta 3.5 ATLAS score",cex.main=1.8, cex.lab=1.5, 
     main = paste("Round ", args$r, sep=""), xlim=c(-52,-10), ylim=c(0,400))
