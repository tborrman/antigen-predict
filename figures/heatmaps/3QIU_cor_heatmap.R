...
parser <- ArgumentParser(description="Script to compute cross-reactivity heatmaps and correlation plots on 3QIU pdb")
...
pdf (paste(wkdir, "/", args$score, "_corr.pdf", sep=""))
  ...
  plot(peptide_numbers, corrs, main= '226', cex.main = 1.8, cex.lab= 1.5, xlab= 'Number of peptides', ylim=c(-0.2, 1.0), ylab= "Pearson's r", pch=20, type='o', col='blue')
dev.off();
