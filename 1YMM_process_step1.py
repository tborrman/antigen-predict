...
def main():
	parser = argparse.ArgumentParser(description= 'Deconvolute 1YMM seq data into rounds of selection from specific library')
	...
	sel_seq = barcode + 'CTGTTATTGCTAGCGTATTGGCC'
	
	OUT = open('1YMM_process_step1.fastq', 'w+')
