...
def main():
	parser=argparse.ArgumentParser(description='Build substitution matrix for 3QIB selections output by 3QIB_process_step1.py to check against Birnbaum results')
	...
	np.savetxt('3QIB_sub_matrix_seq_check.txt', percent_matrix, delimiter='\t', fmt='%1.4f')
